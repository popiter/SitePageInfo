...
function tracking() {
  if (
    ...
    document
      .querySelector(".partner__shop__items27-33")
      .classList.add("content__parther");
  } else if (document.querySelector(".partner__shop__items27-33")) {
    document
      .querySelector(".partner__shop__items27-33")
      .classList.remove("content__parther");
  }
  ...
  if (
    ...
    document
      .querySelector(".servise__subtitle")
      .classList.add("content__servise");
  } else if (
    document.querySelector(".servise__title") &&
    document.querySelector(".servise__subtitle")
  ) {
    document
      .querySelector(".servise__subtitle")
      .classList.remove("content__servise");
    document
      .querySelector(".servise__title")
      .classList.remove("content__servise");
  }
